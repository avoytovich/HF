...
class CreateUser extends Component {
  ...
  _dublicatePostalCode = () => {
    ...
    dispatchCreateUserPayloadWired({
          ...
          <div className="create-user-container">
            <div className="create-user-input-container">
              ...
              <Input
                ...
                reducer={createUsersReducers}
                label="EU VAT nr."
                placeholder="EU VAT nr."
              />
              <Input
                id="legal_info.reg_num"
                reducer={createUsersReducers}
                label="Registration nr. (Non EU)"
                placeholder="Registration nr. (Non EU)"
              />
              <Input
            ...
            <div className="create-user-input-container">
              ...
              <div
                ...
                onClick={this._dublicatePostalCode}
              >
          ...
          <div className="create-user-container">
            <div className="create-user-contacts-container">
                ...
                return (
                  <div key={index} className="create-user-input-container">
                    <div className="delete-item-container">
                      <Input
                        id={`contact_info.contacts[${index}].name`}
                        reducer={createUsersReducers}
                        label="Name"
                        placeholder="Name"
                      />
                      <DeleteIcon
                        onClick={() =>
                          this._deleteContact(
                            index,
                            createUsersReducers.contact_info.contacts
                          )
                        }
                      />
                    </div>
                    <Input
                      id={`contact_info.contacts[${index}].surname`}
                      reducer={createUsersReducers}
                      label="Surname"
                      placeholder="Surname"
                    />
                    <Input
                      id={`contact_info.contacts[${index}].email`}
                      reducer={createUsersReducers}
                      label="Email"
                      placeholder="Email"
                    />
                    <Input
                      id={`contact_info.contacts[${index}].phone`}
                      reducer={createUsersReducers}
                      label="Phone"
                      placeholder="Phone"
                    />
              ...
              <div
                className="add-contact-person"
                onClick={() =>
                  this._addContact(createUsersReducers.contact_info.contacts)
                }
              >
